<?php
/* Template Name: Photos Page w/ Subpages */
get_header();
?>
...
<div class="column--content--full--container">
	...
	foreach ($days as $day) {
		...
		<div class="column column--<?php echo $i; ?> column--content column--content--full">
			<h1 class="photos-title t-uppercase"><?php echo ucfirst($day); ?></h1>
			<div class="photos-column">
				<?php echo web3s_get_photos_columns('photos/'.$post->post_name.'/'.$day); ?>
			</div>
		</div>
